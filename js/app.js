/*! ------------------------------------------------
 * Project Name: Damlas - Digital Agency & Personal Portfolio HTML Template
 * Project Description: Stand out and express your uniqueness with Damlas - a vibrant and minimal HTML template for creatives, studios and freelancers. Impress your website visitors with a clean, stylish layout and stunning visuals.
  ...
  imagesLoaded(imgs, () => {
    ...
    class TrailImage {
      ...
      setSize() {
        ...
        const size = gsap.utils.random(MIN_SIZE, MAX_SIZE);
